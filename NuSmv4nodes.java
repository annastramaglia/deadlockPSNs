...
public class NuSmv4nodes {
	...
	public void writing() {
		...
		try {
			...
			File statText = new File("C:\\Users\\Anna\\Desktop\\FinalProject\\NuSMV-2.6.0-win64\\bin\\NuSmv4nodes.txt");
	...
	public static void main(String[]args) {
		NuSmv4nodes write = new NuSmv4nodes();
		write.writing();
	}
