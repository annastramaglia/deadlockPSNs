...
public class NuSmv17WD {
	...
	public void writing() {
		...
		try {
			...
			File statText = new File("C:\\Users\\Anna\\Desktop\\FinalProject\\NuSMV-2.6.0-win64\\bin\\NuSmv17WD.txt");
			...
			w.write("( C1 != 0 | C2 != 0 | C3 != 0 | C4!= 0 | C5 != 0 | C6 != 0 | C7 != 0 | C8 != 0 | C9 != 0 | C10 != 0 | C11 != 0 | C12 != 0 | C13 != 0 | C14 != 0 | C15 != 0 | C16 != 0 | C17 != 0 | C18 != 0 | C19 != 0 | C20 != 0 | C21 != 0 | C22 != 0 | C23 != 0 | C24 != 0 | C25 != 0 | C26 != 0 | C27 != 0 )" );
			w.write(");");
