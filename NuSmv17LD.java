...
public class NuSmv17LD {
	...
	public void writing() {
		...
		try {
			...
			File statText = new File("C:\\Users\\Anna\\Desktop\\FinalProject\\NuSMV-2.6.0-win64\\bin\\NuSmv17LD.txt");
			...
			for(int i = 0; i < (array.size()-1); i++) {
				w.write("(EF(AG(" + array.get(i) +"))) | ");
			}
			w.write("(EF(AG("+ array.get(array.size()-1) + ")))");
			w.write(");");
